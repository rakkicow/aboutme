...
// `short` is the compact name used on narrow screens so the row stays one line.
export const coursework: { code: string; name: string; short?: string; grade?: string }[] = [
  ...
  { code: 'ECE 20001', name: 'Electrical Engineering Fundamentals I', short: 'Elec. Engr. Fundamentals I', grade: 'A' },
  { code: 'CNIT 18000', name: 'Intro to Systems Development', grade: 'A' },
  { code: 'CNIT 17600', name: 'Information Technology Architectures', short: 'IT Architectures', grade: 'A' },
